...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Мы принимаем оплату через Яндекс.Кассу, Альфа-Банк, Сбербанк и другие популярные платежные системы. Оплата производится безопасно через защищенные платежные шлюзы.',
  },
  {
    id: '4',
    category: 'Оплата',
