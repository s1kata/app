...
6. **Сторы**: скриншоты, описание, политика конфиденциальности, контакты поддержки.
7. **Sentry**: `EXPO_PUBLIC_SENTRY_DSN` в EAS для production; тестовая ошибка видна в консоли Sentry.
